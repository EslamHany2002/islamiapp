...
class _WakeUpScreenState extends State<WakeUpScreen> {
  ...
  Future<void> loadAzkar() async {
    ...
    List<dynamic> azkarMorningList = data['أذكار الاستيقاظ'];
    ...
    setState(() {
      azkarList = filteredList
          ...
          .where((azkar) => azkar.category == 'أذكار الاستيقاظ')
          .toList();
    });
  }
        ...
        body: Stack(
          children: [
            ...
            Positioned(
                ...
                left: 0,
                right: 0,
                child: Center(child: Text("أذكار الاستيقاظ",style: TextStyle(color: Colors.white,fontSize: 20,fontFamily: "janna"),))),
            Positioned(
              top: 120,
              left: 0,
              right: 0,
