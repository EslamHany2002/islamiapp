...
import 'package:islamiapp/models/Azkar.dart';
 // Ensure this model matches your data structure

class AzkarMasaScreen extends StatefulWidget {
  @override
  _AzkarMasaScreenState createState() => _AzkarMasaScreenState();
}

class _AzkarMasaScreenState extends State<AzkarMasaScreen> {
  ...
  Future<void> loadAzkar() async {
    ...
    List<dynamic> azkarEveningList = data['أذكار المساء'];

    // Flatten the list and filter out non-object elements
    List<dynamic> filteredList = [];
    for (var item in azkarEveningList) {
      if (item is List) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          // title: Text('Evening Azkar', style: TextStyle(color: Colors.white),),
        ),
        body: Stack(
          children: [
            Positioned(
            ...
            Positioned(
              ...
              child: Center(
                child: Text(
                  "أذكار المساء",
                  style: TextStyle(color: Colors.white, fontSize: 20, fontFamily: "janna"),
                ),
              ),
            ),
            Positioned(
