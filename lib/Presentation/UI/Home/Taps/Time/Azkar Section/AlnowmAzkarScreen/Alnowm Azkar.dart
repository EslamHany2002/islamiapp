...
class AlnowmAzkarScreen extends StatefulWidget {
  @override
  _AlnowmAzkarScreenState createState() => _AlnowmAzkarScreenState();
}

class _AlnowmAzkarScreenState extends State<AlnowmAzkarScreen> {
  ...
  Future<void> loadAzkar() async {
    ...
    List<dynamic> azkarMorningList = data['أذكار النوم'];
        ...
        body: Stack(
          children: [
            ...
            const Positioned(
                ...
                left: 0,
                right: 0,
                child: Center(child: Text("أذكار النوم",style: TextStyle(color: Colors.white,fontSize: 20,fontFamily: "janna"),))),
            Positioned(
              top: 120,
              left: 0,
              right: 0,
