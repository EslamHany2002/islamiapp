...
class TasabihScreen extends StatefulWidget {
  @override
  _TasabihScreenState createState() => _TasabihScreenState();
}

class _TasabihScreenState extends State<TasabihScreen> {
  ...
  Future<void> loadAzkar() async {
    ...
    List<dynamic> azkarMorningList = data['تسابيح'];
    ...
    setState(() {
      azkarList = filteredList
          ...
          .where((azkar) => azkar.category == 'تسابيح')
          .toList();
    });
  }
        ...
        body: Stack(
          children: [
            ...
            const Positioned(
                ...
                left: 0,
                right: 0,
                child: Center(child: Text("تسابيح",style: TextStyle(color: Colors.white,fontSize: 20,fontFamily: "janna"),))),
            Positioned(
              top: 120,
              left: 0,
              right: 0,
