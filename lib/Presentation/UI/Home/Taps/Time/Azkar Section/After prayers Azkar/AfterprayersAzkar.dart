...
class AfterprayersScreen extends StatefulWidget {
  @override
  _AfterprayersScreenState createState() => _AfterprayersScreenState();
}

class _AfterprayersScreenState extends State<AfterprayersScreen> {
  ...
  Future<void> loadAzkar() async {
    ...
    List<dynamic> azkarMorningList = data['أذكار بعد السلام من الصلاة المفروضة'];
    ...
    setState(() {
      azkarList = filteredList
          ...
          .where((azkar) => azkar.category == 'أذكار بعد السلام من الصلاة المفروضة')
          .toList();
    });
  }
        ...
        body: Stack(
          children: [
            ...
            const Positioned(
                ...
                left: 0,
                right: 0,
                child: Center(child: Text("أذكار بعد الصلاة",style: TextStyle(color: Colors.white,fontSize: 20,fontFamily: "janna"),))),
            Positioned(
              top: 120,
              left: 0,
              right: 0,
