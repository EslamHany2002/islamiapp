...
class ProphetsSuplicationsScreen extends StatefulWidget {
  @override
  _ProphetsSuplicationsScreenState createState() => _ProphetsSuplicationsScreenState();
}

class _ProphetsSuplicationsScreenState extends State<ProphetsSuplicationsScreen> {
  ...
  Future<void> loadAzkar() async {
    ...
    List<dynamic> azkarMorningList = data['أدعية الأنبياء'];
    ...
    setState(() {
      azkarList = filteredList
          ...
          .where((azkar) => azkar.category == 'أدعية الأنبياء')
          .toList();
    });
  }
        ...
        body: Stack(
          children: [
            ...
            const Positioned(
                ...
                left: 0,
                right: 0,
                child: Center(child: Text("أدعية الأنبياء",style: TextStyle(color: Colors.white,fontSize: 20,fontFamily: "janna"),))),
            Positioned(
              top: 120,
              left: 0,
              right: 0,
